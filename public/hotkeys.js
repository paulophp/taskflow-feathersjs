...
$('.finder').bind('keydown', 'return', function assets() {
  $('.finder').blur()
  console.log('test');
...
$(document).bind('keydown', 'shift+n', function assets() {
  window.location = '#/add_tarefa'
})

$(document).bind('keydown', 'shift+q', function assets() {
...
$(document).bind('keydown', 'shift+1', function assets() {
...
$(document).bind('keydown', 'shift+2', function assets() {
...
$(document).bind('keydown', 'shift+down', function assets() {
    //console.log('down');
    //return false;

    // menu left
    var li = $('.nav-sidebar li.active').next('li')
    li.addClass('active').prev('li').removeClass('active')
    li.find('a').focus()
...
$(document).bind('keydown', 'shift+left', function assets() {
    //console.log('down');
    //return false;

    // menu left
    var li = $('.placeholders').find('a.active')
    var next = li.parents('.placeholder').prev('div').find('a').length
    if(next == 0){
      return false
    };

    li.parents('.placeholder').prev('div').find('a').addClass('active').focus()
    li.removeClass('active')


});
$(document).bind('keydown', 'shift+right', function assets() {
    //console.log('down');
    //return false;

    // menu left
    var li = $('.placeholders').find('a.active')
    var next = li.parents('.placeholder').next('div').find('a').length
    if(next == 0){
      return false
    };

    li.parents('.placeholder').next('div').find('a').addClass('active').focus()
    li.removeClass('active')
...
$(document).bind('keydown', 'shift+up', function assets() {
    //console.log('down');
    //return false;

    // menu left
    var li = $('.nav-sidebar li.active').prev('li')
    li.addClass('active').next('li').removeClass('active')
    li.find('a').focus()
